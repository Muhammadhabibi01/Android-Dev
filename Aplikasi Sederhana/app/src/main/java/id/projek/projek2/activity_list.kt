...
class activity_list : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val list1 = findViewById<ImageButton>(R.id.laskarpelangi)
        val list2 = findViewById<ImageButton>(R.id.mrestaurant)
        val list3 = findViewById<ImageButton>(R.id.matahari)
        val list4 = findViewById<ImageButton>(R.id.kekang)
        val list5 = findViewById<ImageButton>(R.id.tikungan)
        val list6 = findViewById<ImageButton>(R.id.ubur)
        ...
        list2.setOnClickListener {
            val intent = Intent(this, MidnightRestaurant::class.java)
            startActivity(intent)
        }
